...
<title></title>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-image:url(img1/bg.jpg); background-repeat:no-repeat;background-size: 1800px;">
    <a class="navbar-brand" style="margin-bottom:12px; padding-top:10px; font-size:27px" href="../index.php">PlayMap</a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" >
      ...
      <ul class="navbar-nav mr-auto" align="right">
        ...
        <li class="nav-item" style="font-size:24px;">
          <a class="nav-link" href="login.php?uinfo=1">Host Game</a>
        </li>
   
        <li class="nav-item" style="font-size:24px;">
          <a class="nav-link" href="login.php?uinfo=2">Let's Play </a>
        </li>
        <li class="nav-item" style="font-size:24px;">
          ...
          <li class="nav-item" style="font-size:24px;">
          <a class="nav-link " href="contactus.php" align="right">Contact Us</a>
        </li>
