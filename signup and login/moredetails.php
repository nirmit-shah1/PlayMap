...
echo "<td align='center' style='color:#0099FF' ><a class='btn btn-warning ' href=moredetailsofgameadmin.php?routeid=".$row1['mid']."&gameid=".$row1['reg_id'].">More Details </a></td></tr>";
}

?>
       
</table>
<a href="gameoffer.php"><font color="#990000" size="+2"><-Back to Games Offer Page</font></a>
</div>
</body>
</html>
