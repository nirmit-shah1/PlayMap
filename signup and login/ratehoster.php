...
//=====================================================MAIN CODE=========================================
				$sql0=mysqli_query($con,"select * from booking where reg_id= '".$reg_id."'");
					while($final1=mysqli_fetch_array($sql0))
					{
						...
						if($final == 1)
						{
							$sql1=mysqli_query($con,"select * from signup_details where reg_id='".$hid."'");
							...
							<?php	
								echo "<a style='color: #0066CC; padding-left: 31px;' href='ratingdetails.php?hosterid=".$hid."'>Rate And Comment $row1[1] $row1[2]</a>"?></h2>			
	<?php
