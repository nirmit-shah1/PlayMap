...
<html>
	...
	<body style=" background-image:url(img1/privacy1.jpg);background-repeat:no-repeat;background-size:cover;">
		<div class="white-box" >
			...
			<html>
			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<?php $alias_id=$_SESSION['senderid'];
...
<br>
			...
			<?php
				...
				if(isset($_POST['submit12']) || isset($_POST['submit2']) )
				{
...
?>
    ...
    margin-left: 391px;" class="button-3" value="Unsend the request" /></form>
				<?php       } 
							else if($_info12['status'] == 'match')
							{
				?>
						<form method="POST" action="frieendrequestback.php">
				   		<input type="submit" name="block" style="background:#FB1E1E;    margin-top: -698px;
    margin-left: 391px;" class="button-3" value="Block" /></form>
				 <?php
							}
						}
					}
